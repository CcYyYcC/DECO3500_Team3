...
| 10 | 10/6 – 10/9 | ⚠️ **A1 个人 Portfolio 周三1pm截止（个人交，非组内）** | 继续原型开发，回应 stand-up 反馈 |
| 11 | 10/12 – 10/16 | — | 第二轮用户测试，优化原型；开始起草海报/文案 |
| 12 | 10/19 – 10/23 | ✅ **A3b Tradeshow**（studio内） | 定稿A2海报+3分钟pitch，原型可演示状态 |
| 13 | 10/26 – 10/30 | ✅ **A3c Artefacts 周一3pm截止** | GitHub repo 收尾：README、WIKI（Design Process Overview + Ethics）、PDF导出 |
...
### Week 7（9/7–9/11）
- [ ] 完成研究综合（synthesis），不是转录全文而是提炼 insight
- [ ] 低保真原型第一版
- [ ] 排一次内部 stand-up，写进 WIKI

### Week 8（9/14–9/18）
- [ ] Initial requirements 定稿并写入 GitHub 文档
- [ ] 功能原型开始搭建
- [ ] 安排第一轮用户测试（真实用户或 proxy）

### Week 9（9/21–9/25）
- [ ] Stand-up WIKI 页面提前写好（研究发现/需求/早期原型/测试结果/下一步）
- [ ] 全员准备好各自的发言（做了什么、接下来做什么）
- [ ] Studio 内 stand-up 演讲

---

## 使用说明 · How to Use This File

把这个文件放在 repo 根目录或 `docs/WEEKLY_PLAN.md`，每周结束后勾选完成项、补充下一周细节。建议配合 GitHub Projects 看板（见 `GITHUB_PROJECT_SETUP.md`）逐条拆解成 issue。

Drop this in the repo root or `docs/WEEKLY_PLAN.md`. Check off items weekly and flesh out the next week's detail section. Pair with the GitHub Projects board (see `GITHUB_PROJECT_SETUP.md`) to break each line into tracked issues.
